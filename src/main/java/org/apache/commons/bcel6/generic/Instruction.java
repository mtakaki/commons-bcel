...
public abstract class Instruction implements Cloneable {
    private static final InstructionComparator cmp = InstructionComparator.DEFAULT;
    ...
    public void dump(final DataOutputStream out) throws IOException {
        out.writeByte(this.opcode); // Common for all instructions
    }
     ...
     * @throws IOException
     *             may be thrown if the implementation needs to read data from
     *             the file
     */
    ...
    public static Instruction readInstruction(final ByteSequence bytes) throws IOException {
        ...
        if (wide
                && !((obj instanceof LocalVariableInstruction) || (obj instanceof IINC)
                        || (obj instanceof RET))) {
     ...
     * @deprecated use the built in comparator, or wrap this class in another
